 ...
 * @author sunnyladdy
 */
public class showpassportcard1 extends javax.swing.JInternalFrame implements mydbvariables{

    /**
     * Creates new form showpassportcard1
     */
    public static boolean flag = false,securitypass = false;
    public static String idnumber="";
    
    public showpassportcard1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        topcardname.setIcon(new javax.swing.ImageIcon(getClass().getResource("/password_manager/images/passporticon.png"))); // NOI18N
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/password_manager/images/passportbackground.png"))); // NOI18N
        ...
        passwordprotected.setBounds(10, 487, 388, 30);
        ...
        jLabel1.setText("Place Of Issue");
        showingDetailss.add(jLabel1);
        jLabel1.setBounds(40, 450, 80, 30);
        showingDetailss.add(placeofissue);
        placeofissue.setBounds(154, 446, 240, 30);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(showingDetailss, javax.swing.GroupLayout.PREFERRED_SIZE, 410, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(showingDetailss, javax.swing.GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        if(securitypass != false)
        {
            try
            {
                ...
                try
                {
                    String query = "UPDATE `idcards` SET `cardname`=?,`cardnumber`=?,`gender`=?,`dob`=?,`issuedate`=?,`expirydate`=?,`passwordprotected`=?,`placeofissue`=?,`note`=? WHERE sno=?";
                    ...
                    obj.setString(8, placeofissue.getText());
                    obj.setString(9, usernote.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        dashlane.flag = false;
        flag = false;
        verifypasswordframe.passportcard = false;
        //cardholdername.setEchoChar('*');
        //dashlane.showpassin.setVisible(false);
        showpass.showpassin.setVisible(false);
    ...
    public static javax.swing.JTextField placeofissue;
